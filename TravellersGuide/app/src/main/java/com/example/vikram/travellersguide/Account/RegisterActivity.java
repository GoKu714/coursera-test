package com.example.vikram.travellersguide.Account;

import android.content.Intent;
import com.example.vikram.travellersguide.userData;
...
public class RegisterActivity extends AppCompatActivity {
   ...
   private EditText af_name,al_name,a_username,a_password,a_contact_no,a_email;
    private String f_name,l_name,username,password,contact_no,email;
    Button register;
   ...
   private DatabaseReference mdatabase;
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                   // progressDialog.dismiss();
                    if(task.isSuccessful())
                    {
                        ...
                        userData user= new userData(f_name,l_name,username,contact_no,email);
    ...
    public Boolean validate()
    {
        ...
        if(username.isEmpty() || username.length()>15) {
            a_username.setError("Please Enter Valid Fisrt Name");
            valid=false;
        }
    ...
    public void initialize()
    {
        ...
        username=a_username.getText().toString().trim();
